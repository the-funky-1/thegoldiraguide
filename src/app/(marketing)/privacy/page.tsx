  ...
  return (
    <div className="px-6 py-10">
      ...
      <article className="mx-auto mt-8 max-w-3xl">
        <h1 className="font-serif text-4xl font-bold">Privacy and Analytics</h1>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            ...
            Analytics when the corresponding deployment environment variables
            are configured. These tools report aggregate page activity,
            navigation, device and browser context, and interaction events for
            calculators and comparison tables.
          </p>
          <p>
            ...
            as the exact value entered. Names, emails, phone numbers, and
            written estimate request details must not be sent to analytics.
          </p>
        </section>
